...
| 2 | Core Rust fundamentals | IN PROGRESS | First executable sequence covers bindings, values, text, functions/control flow, data types/modules, and attributes; remaining baseline coverage is pending. |
| 3 | Ownership, borrowing, lifetimes, smart pointers | NOT STARTED | Deep memory/lifetime sequence and mental models complete. |
